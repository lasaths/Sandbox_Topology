...
namespace Sandbox.Topology.Grasshopper
{
    public class TopologyBrepEdge : GH_Component
    {
        /// <summary>
        ...
        /// </summary>
        public TopologyBrepEdge()
          : base("Brep Topology Edge",
                "Brep Topo Edge",
        ...
        protected override void SolveInstance(IGH_DataAccess DA)
        {
            ...
            Brep _brep = null/* TODO Change to default(_) if this is not a reference type */;
            ...
            DataTree<Int32> e_tree = new DataTree<Int32>();

            foreach (BrepFace _face in _brep.Faces)
            {
                Int32[] _edges = _face.AdjacentEdges();
                GH_Path e_path = new GH_Path(e_tree.BranchCount);
                e_tree.AddRange(_edges, e_path);
            }


            DataTree<Int32> f_tree = new DataTree<Int32>();

            foreach (BrepEdge _edge in _brep.Edges)
            {
                Int32[] _faces = _edge.AdjacentFaces();
                GH_Path f_path = new GH_Path(f_tree.BranchCount);
        ...
        /// </summary>
        protected override System.Drawing.Bitmap Icon => Resources.TopologyBrepEdge;
        ...
        /// </summary>
        public override Guid ComponentGuid => new Guid("5A26FFB9-B83A-4971-B6EA-F00CDC1716A0");
